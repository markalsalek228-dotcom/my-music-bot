...
async def play_music(client, message):
    ...
    try:
        ydl_opts = {'format': 'bestaudio/best', 'outtmpl': 'downloads/%(title)s.%(ext)s', 'postprocessors': [{'key': 'FFmpegExtractAudio','preferredcodec': 'mp3','preferredquality': '192'}]}
...
async def main():
    await start_server() # تشغيل السيرفر الوهمي
    async with app:
        print("البوت بدأ العمل مجاناً!")
